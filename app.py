...
llm_gemini = ChatGoogleGenerativeAI(
    model="gemini-pro",  # Use "gemini-1.5-pro" or other available models
    temperature=0,
...
def generate_visualization_code(user_prompt: str) -> str:
    """
...
def main():
    ...
    if st.sidebar.button("Generate Visualization Code"):
        ...
        code = generate_visualization_code(user_prompt)
